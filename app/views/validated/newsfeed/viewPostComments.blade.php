               ...
               <div id="commentTemp" class="hidden">
                    <div id="cloneable">
                        <div class="post-header clearfix">
                           ...
                           <span id="name" data-target="/profile/{{$post->owner->StudentID}}">{{Auth::user()->Firstname . ' ' . Auth::user()->Lastname}}</span>
                           <p id="commentMessage">
               ...
               @if(count($comments))
                    @foreach($comments as $comment)
                        <div class="post-header clearfix">
                           ...
                           <span id="name" data-target="/profile/{{$comment->owner->StudentID}}">{{$comment->owner->Firstname . ' ' . $comment->owner->Lastname}}</span>
                    ...
                    @endforeach
               @else
               <div class="alert-info text-center padding-sm">No comments yet.</div>
               @endif
               </div>
            </div>
        </div>
