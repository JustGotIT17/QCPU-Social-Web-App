...
<div class="container margin-top-xxl">
                  ...
                  <div class="message-container clearfix">
                      ...
                      <span class="clearfix">
                          ...
                          <span id="name" data-target="/messages/view/{{$message->owner->StudentID}}" class="pull-right">
                            <span id="silentPostRequest" data-target="/messages/group/delete/{{$message->ID}}" data-hide="true" data-parent="message-container" data-accid="{{$message->owner->StudentID}}" data-id="{{$message->ID}}"><i class="fa fa-remove fa-fw"></i> </span>
                            {{(User::isOnline($message->owner->lastSeen))}}
                            Me
                          </span>
                          <br/>
    ...
    <div class="navbar navbar-default navbar-fixed-bottom">
      {{Form::open(['url' => '/messages/mygroup/reply/'.$id, 'data-target'=>'/messages/mygroup/view/'.$id, 'id'=>'formPostPersonalReply', 'role' => 'form'])}}
